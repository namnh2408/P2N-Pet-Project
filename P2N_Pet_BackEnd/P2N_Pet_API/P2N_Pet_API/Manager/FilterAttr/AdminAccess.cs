...
namespace P2N_Pet_API.Manager.FilterAttr
{
    ...
    {
        private string KeyAdmin = "Priv@te@Key!P2NPet#Admin2021";
        ...
        public override void OnActionExecuting(ActionExecutingContext filterContext)
        {
            ...
            if (headers.ContainsKey("Authorization"))
            {
                ...
                var adminRole = Utils.GetRoleFromToken(filterContext.HttpContext.Request);
                ...
                else if(Signature.CheckTokenValid(token) && adminRole != 10)
                {
                    filterContext.HttpContext.Response.StatusCode = (int)System.Net.HttpStatusCode.Unauthorized;
                    filterContext.Result = new ContentResult
                    {
